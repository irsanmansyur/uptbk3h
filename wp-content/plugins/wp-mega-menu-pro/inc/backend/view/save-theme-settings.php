...
wp_redirect(admin_url('admin.php?page=wpmm-add-theme-pro&action=edit_theme&theme_id='.$themeid.'&_wpnonce='.$nonce.'&message=1'));
}else{
...
wp_redirect(admin_url('admin.php?page=wpmm-theme-pro-settings&message=2'));
}
exit();